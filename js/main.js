...
// Để kiểm tra xem radio nào đang được chọn, ta dùng thuộc tính checked
  console.log("A", radioA.checked);
  console.log("B", radioB.checked);
  console.log("C", radioC.checked);
  console.log("X", radioX.checked);
// Để kiểm tra xem radio nào đang được chọn, ta dùng thuộc tính checked
  console.log("1", radio1.checked);
  console.log("2", radio2.checked);
  console.log("3", radio3.checked);
  console.log("0", radio0.checked);
...
function diemtong(){
   ...
   let scoreAll = score1 + score2 + score3 + diemkv + diemdt;
...
function genderChanged(obj)
{
    ...
    if (value === ''){
        ...
        message.innerHTML = "Bạn đã chọn dùng đầu kết nối";
    }
    else if (value === 'nd'){
        message.innerHTML = "";
    }
...
function ex4() {
  ...
  alert("Tiền cáp của bạn là: "+ tiencap.toLocaleString());
}